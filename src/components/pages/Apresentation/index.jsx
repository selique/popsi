                ...
                <div className='relative w-full h-full p-8 flex flex-col justify-between items-center overflow-hidden'>
                    ...
                    <div className='w-full flex justify-end'>
                        <Link to='/tabs'>
                            <div className='flex items-center'>
                                <IonText className='capitalize text-medium'>Pular</IonText>
                                <IonIcon icon={chevronForward} className="text-2xl text-black-100" />
                            </div>
                        </Link>
                    </div>
                    <div className='flex flex-col items-center w-full'>
                        ...
                        <IonText className='text-xsm text-black text-center font-extralight mt-2'>
                            At vero eos et accusamus et iusto odio ignissimos ducimus qui blanditiis praesenti.
                        </IonText>
                    </div>
                    <div className='w-2/3'>
                        <Link to="#">
